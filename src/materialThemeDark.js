...
function getTheme({ theme, name, bgColor, saturation }) {
  ...
  if (saturation == "low") {
    colors.secondaryText = adjustHsl(colors.bg, -10, -5, 40);
    colors.secondaryAccent = adjustHsl(colors.bg, -10, 30, 50);
    colors.comment = adjustHsl(colors.bg, -10, -5, 40);
  } else {
    colors.secondaryText = adjustHsl(colors.bg, -10, -30, 40);
    colors.secondaryAccent = adjustHsl(colors.bg, -10, 17, 50);
    colors.comment = adjustHsl(colors.bg, -10, -30, 40);
  }
